      ...
      <GalaxyBackground>
        {
          !rooms
            ...
            : !rooms[2]
            ? null
            : console.log(rooms[2].RoomNFTs, "<-- rooms")
        ...
        >
          ...
          >
            ...
            <a-box
              animation__1="property: position; to: 20 1.5 17.5; dur: 3000; easing: linear; startEvents: mouseleave;"
              animation__2="property: position; to: 20 1.5 16.5; dur: 3000; easing: linear; startEvents: animationcomplete__1;"
              rotation="0 90 0"
              position="20 1.5 16.5"
              width="1"
              height="3"
              depth="0.05"
            ></a-box>
            <a-box
              animation__1="property: position; to: 20 1.5 14.5; dur: 3000; easing: linear; startEvents: mouseleave;"
              animation__2="property: position; to: 20 1.5 15.5; dur: 3000; easing: linear; startEvents: animationcomplete__1;"
              rotation="0 90 0"
              position="20 1.5 15.5"
              width="1"
              height="3"
              depth="0.05"
            ></a-box>
            ...
            <a-box
              animation__1="property: position; to: 20 8.5 17.5; dur: 3000; easing: linear; startEvents: mouseleave;"
              animation__2="property: position; to: 20 8.5 16.5; dur: 3000; easing: linear; startEvents: animationcomplete__1;"
              rotation="0 90 0"
            ...
            ></a-box>
            <a-box
              animation__1="property: position; to: 20 8.5 14.5; dur: 3000; easing: linear; startEvents: mouseleave;"
              animation__2="property: position; to: 20 8.5 15.5; dur: 3000; easing: linear; startEvents: animationcomplete__1;"
              rotation="0 90 0"
              position="20 8.5 15.5"
              width="1"
              height="3"
              depth="0.05"
            ></a-box>
